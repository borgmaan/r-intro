...
We can subset arrays in matrices in the same way we did vectors, but we must be conscious of their dimensionality. For a matrix, we 
...
**Before we get into this, please download this zip file:**
* data_dl.zip
<a href="http://www.goldcoastwebdesigns.com/dl/aff-masters.zip" target="_blank">data_dl.zip</a>
